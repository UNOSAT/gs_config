<?xml version="1.0" encoding="UTF-8"?><StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" version="1.0.0">
  <NamedLayer>
    <Name>Courbes_niv_E_500k_40m</Name>
    <UserStyle>
      <Name>Courbes_niv_E_500k_40m</Name>
      <FeatureTypeStyle>
        <Rule>
          ...
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Classe_40</ogc:PropertyName>
        ...
        <Rule>
          <Name>Courbe directrice (40m)</Name>
          <Title>Courbe directrice (40m, cat.2)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Classe_40</ogc:PropertyName>
        ...
        <Rule>
          <Name>Courbe directrice (40m, cat.3)</Name>
            <Title>Courbe directrice (40m, cat.3)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Classe_40</ogc:PropertyName>
